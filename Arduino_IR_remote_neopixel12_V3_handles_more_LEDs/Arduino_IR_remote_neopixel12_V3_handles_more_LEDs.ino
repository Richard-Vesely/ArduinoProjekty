...
// LED update optimization - simplified and honest
unsigned long lastLedUpdateMs = 0;
unsigned long ledUpdateIntervalMs = 200;      // Max 20 FPS for LED updates
...
void loop() {
  ...
  // Update LEDs if needed (throttled to max 20 FPS)
  updateLEDsIfNeeded();
