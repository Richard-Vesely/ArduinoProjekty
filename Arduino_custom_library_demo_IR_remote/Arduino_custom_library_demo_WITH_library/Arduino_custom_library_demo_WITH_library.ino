/******************************************************
VERZE A — S TVOU KNIHOVNOU MyIRcodes.h
(Option A: #include <MyIRcodes.h>)
...
void setup() {
  Serial.begin(115200);
  delay(50);
  Serial.println(F("\nIR + NeoPixel 12 — 9 shows, speed & brightness control (MyIRcodes.h)"));
